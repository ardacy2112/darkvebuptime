...
//YouTube; Erasty
    ...
    .addStringOption(option =>
        option//YouTube; Erasty
            ...
            .setRequired(true)),//YouTube; Erasty
    ...
    return interaction.reply({embeds: [YetkiYok]});
      ...
      if (evaled.match(new RegExp(`${client.token}`, "g")));
         ...
         if (evaled.includes(client.token)) return interaction.reply({embeds: [Token]});//YouTube; Erasty
         ...
         } catch (err) {//YouTube; Erasty//YouTube; Erasty
